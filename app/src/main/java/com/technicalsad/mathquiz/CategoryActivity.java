    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countingtoword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(CategoryActivity.this,CountingToWordActivity.class);
        ...
        addition.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CategoryActivity.this, AdditionActivity.class);
                intent.putExtra("musicstate",musicstate);
                startActivity(intent);
            }
        });
        ...
        subtract.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CategoryActivity.this, SubtractActivity.class);
                intent.putExtra("musicstate",musicstate);
                startActivity(intent);
            }
        });
        ...
        multiply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CategoryActivity.this, MultiplicationActivity.class);
                intent.putExtra("musicstate",musicstate);
                startActivity(intent);
            }
        });
        ...
        division.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CategoryActivity.this, DivisionActivity.class);
                intent.putExtra("musicstate",musicstate);
                startActivity(intent);
            }
        });
