...
public class CountingToWordActivity extends AppCompatActivity {

    TextView counting,option1,option2,option3,option4,times,score,vpoint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counting_to_word);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog backdialog = new Dialog(CountingToWordActivity.this);
    ...
    public void newquestion(){
        ...
        if(randomnumber>2){
            optionList.add(randomnumber-1);
            optionList.add(randomnumber-2);
            optionList.add(randomnumber);
            optionList.add(randomnumber+1);
            optionList.add(0);

            counting.setText(String.valueOf(randomnumber));

            int option1txt=random.nextInt(4);
            option1.setText(convertNumberToWord(optionList.get(option1txt)));
            optionList.remove(option1txt);
            option1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    checkanswer(option1,convertNumberToWord(randomnumber),option1.getText().toString().trim());
                }
            });


            int option2txt=random.nextInt(3);
            option2.setText(convertNumberToWord(optionList.get(option2txt)));
            optionList.remove(option2txt);
            option2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    checkanswer(option2,convertNumberToWord(randomnumber),option2.getText().toString().trim());
                }
            });

            int option3txt=random.nextInt(2);
            option3.setText(convertNumberToWord(optionList.get(option3txt)));
            optionList.remove(option3txt);
            option3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    checkanswer(option3,convertNumberToWord(randomnumber),option3.getText().toString().trim());
                }
            });

            int option4txt= 0;
            option4.setText(convertNumberToWord(optionList.get(option4txt)));
            optionList.remove(option4txt);
            option4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    checkanswer(option4,convertNumberToWord(randomnumber),option4.getText().toString().trim());
                }
            });
        }
        else {
    ...
    public void showquizenddialog(int right,int wrong,int score){
        ...
        Dialog dialog = new Dialog(CountingToWordActivity.this);
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CountingToWordActivity.this,CountingToWordActivity.class);
